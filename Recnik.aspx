<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recnik.aspx.cs" Inherits="Zadatak_B10.Recnik" %>
...
<body>
    ...
    <table class="auto-style2">
        <tr>
            <td class="auto-style4">Smer:</td>
            <td class="auto-style3">
                <asp:DropDownList ID="DropDownList" runat="server" Width="131px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList_SelectedIndexChanged">
                    <asp:ListItem>Iz Srpskog</asp:ListItem>
                    <asp:ListItem>Iz Engleskog</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style3">
                <asp:TextBox ID="TextBoxEngl" runat="server" Width="131px" Enabled="False"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button4" runat="server" Text="Prevedi" Width="90px" OnClick="Button4_Click"/>
            </td>
        </tr>
    </table>
